...
public class Multiplicador extends UnicastRemoteObject implements Calculadora {
    ...
    public double divv(double x, double y) throws RemoteException {
        throw new RemoteException("Esse servidor nao suporta essa operaçao! ");
//        Esse trecho de codigo esta comentado pq nao tem 
//        interaçao com o node, esse estoura erro na arquitetura
